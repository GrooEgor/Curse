...
$(BIN_DIR)alphabet: $(BUILD_DIR)main.o $(BUILD_DIR)input.o $(BUILD_DIR)output.o $(BUILD_DIR)tools.o 
	g++ $(FLAG) $(BUILD_DIR)main.o $(BUILD_DIR)input.o $(BUILD_DIR)output.o $(BUILD_DIR)tools.o -o $(BIN_DIR)alphabet
...
$(BUILD_DIR)tools.o: $(SRC_DIR)tools.cpp
	g++ $(FLAG) -c $(SRC_DIR)tools.cpp -o $(BUILD_DIR)tools.o $(STD_FLAG)

$(BIN_DIR)test: $(BUILD_TEST_DIR)input_test.o $(BUILD_TEST_DIR)output_test.o $(BUILD_TEST_DIR)tools_test.o $(BUILD_DIR)input.o $(BUILD_DIR)output.o $(BUILD_DIR)tools.o
	g++ $(BUILD_TEST_DIR)input_test.o  $(BUILD_TEST_DIR)output_test.o $(BUILD_TEST_DIR)tools_test.o $(BUILD_DIR)input.o $(BUILD_DIR)output.o $(BUILD_DIR)tools.o -o $(BIN_DIR)test
...
$(BUILD_TEST_DIR)tools_test.o: $(TEST_DIR)tools_test.cpp 
